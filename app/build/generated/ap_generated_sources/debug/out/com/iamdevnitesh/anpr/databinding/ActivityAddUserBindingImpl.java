...
import com.iamdevnitesh.anpr.BR;
...
public class ActivityAddUserBindingImpl extends ActivityAddUserBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.EdtTxtLayoutUserName, 1);
        sViewsWithIds.put(R.id.EdtTxtUserName, 2);
        sViewsWithIds.put(R.id.EdtTxtLayoutPassword, 3);
        sViewsWithIds.put(R.id.EdtTxtPassword, 4);
        sViewsWithIds.put(R.id.BtnRegister, 5);
    }
    // views
    @NonNull
